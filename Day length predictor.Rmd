...
![Figure 1. How to work out day length using geometry.](geometry.png){#id .class width=600 height=800px}
...
![Figure 2. Trigonometric workings that calculate the lengths of various lines in the geometric figure that give us length of day and night at the summer solsice at 60N.](workings.png){#id .class width=600 height=800px}
